...
| R Studio Notebook              | [r-studio](https://github.com/SDSU-Research-CI/rstudio-desktop-notebook) | ghcr.io/sdsu-research-ci/rstudio-desktop-notebook:v2.0 | Everything in NRP R Studio Notebook <br/><br/> RStudio <br/><br/> Jupyter Desktop |
...
| SageMath Notebook           | [sagemath-notebook](https://github.com/SDSU-Research-CI/sagemath-notebook) | ghcr.io/sdsu-research-ci/sagemath-notebook:2.0 | Everything in jupyter/scipy-notebook <br/><br/> SageMath Kernel |
